...
public class CSVDataProvider {
    ...
    // DataProvider público llamado "postsCsv" que puede usarse desde tests
    ...
    public static Object[][] postsCsv() throws Exception {
        ...
        for (String line : lines) { // iteramos cada línea
            line = line.trim(); // limpiamos espacios
            if (line.isEmpty() || line.startsWith("#")) { // ignorar cabeceras o líneas comentadas
                continue;
            }
