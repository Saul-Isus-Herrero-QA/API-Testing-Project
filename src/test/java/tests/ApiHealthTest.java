package tests; // paquete donde están los tests
...
public class ApiHealthTest extends BaseTest { // la clase extiende BaseTest para heredar configuración
    ...
    public void healthCheck() { // nombre del caso de prueba que verifica el endpoint /get
        given() // inicia la construcción de la petición con RestAssured
                .log().all() // registra toda la petición en consola para poder revisarla y debuggar
                ...
                .log().all() // registra toda la respuesta en consola
                .statusCode(200) // verifica que el código HTTP sea 200 correcto.
                // Validación de campos devueltos por el endpoint (URL específica de una API donde nos conectamos) https://jsonplaceholder.typicode.com/posts/1 :
